        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/avatar-type" className="text-gray-600 hover:text-primary">Try Demo</Link></li>
              <li><Link to="/waitlist" className="text-gray-600 hover:text-primary">Join Waitlist</Link></li>
            </ul>
          </div>
