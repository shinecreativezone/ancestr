...
import { Upload, MessageCircle, Image, Mic, FileText, RefreshCw, CheckCircle } from "lucide-react";
...
export default function TwinUpload() {
  ...
  const handleContinue = () => {
    // Navigate to the demo chat page
    navigate("/demo-chat");
  };
  
  const handleSkip = () => {
    // Skip the uploads and go directly to demo
    navigate("/demo-chat");
  };
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <div className="flex justify-center space-x-4 mt-4">
                ...
                <Button onClick={handleContinue} disabled={uploadProgress < 100}>
                  {uploadProgress < 100 ? "Processing..." : "Continue to Chat"}
                </Button>
              </div>
            </div>
